...
from src.visualizations.maps import build_component_bottleneck_map, build_disparity_map, build_hdi_map, build_three_map
...
view_mode = st.sidebar.radio(
    "Select Mode",
    ["HDI Overview", "Bottleneck Overview", "3 Component Bottleneck", "three map"],
    index=0
)
...
if gdf is not None:
    if view_mode == "HDI Overview":
        ...
        fig, region_indices = build_three_map(
            gdf,
            geojson_data,
            bottleneck_components,
            bottleneck_values,
